...
_G.packer_plugins = {
  ...
  buftabs = {
    loaded = true,
    path = "/home/luis/.local/share/nvim/site/pack/packer/start/buftabs",
    url = "https://github.com/zefei/buftabs"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
  ...
  colorizer = {
    loaded = true,
    path = "/home/luis/.local/share/nvim/site/pack/packer/start/colorizer",
  ...
  ["sxhkd-vim"] = {
    loaded = true,
    path = "/home/luis/.local/share/nvim/site/pack/packer/start/sxhkd-vim",
    url = "https://github.com/kovetskiy/sxhkd-vim"
  },
  ["vim-transparent"] = {
    loaded = true,
    path = "/home/luis/.local/share/nvim/site/pack/packer/start/vim-transparent",
